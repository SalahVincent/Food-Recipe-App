...
<div className='flex items-center gap-2 px-3 py-1.5 rounded-2xl'>
  <div className="bg-[#00000013] flex items-center gap-2 px-3 py-1.5 rounded-2xl">
        ...
        <div className="flex h-8 justify-around w-35">
          ...
          <img
              className={`cursor-pointer h-7 transition-all ${isActive("/notifications") ? "filter-active-red" : ""}`}
            ...
            <img
              className={`cursor-pointer h-7  transition-all ${isActive("/messages") ? "filter-active-red" : ""}`}
              src="./forum.svg"
              alt="Messages"
            ...
            <img
              className={`cursor-pointer h-7 rounded-full transition-all ${isActive("/profile") ? "border-2 border-[#e63946]" : ""}`}
              src="./pp.jpeg"
              alt="Profile"
