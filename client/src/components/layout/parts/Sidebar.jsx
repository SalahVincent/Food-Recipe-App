        ...
        {recipe ? (
          <div className="flex flex-col h-full">
            ...
            <div className="flex gap-4 mb-8">
              <span className="bg-red-400 text-white py-2 px-4 rounded-full text-[15px]">
                {recipe.prepTime} mins
              </span>
              <span className="bg-gray-300 text-white py-2 px-4 rounded-full">
                {recipe.servings} people{" "}
              </span>
            </div>

            <div className="mb-6">
              <h4 className="font-bold text-green-600 uppercase text-sm mb-2 flex gap-2">
                <img src="./egg.svg" alt="" />
                Ingredients
              </h4>
            ...
            <div className="mt-auto pt-10 flex gap-4">
              <Button
                onClick={handleEdit}
                className="flex-1 bg-gray-200 text-gray-700 hover:bg-gray-300 transition-colors"
              >
                Edit Recipe
              </Button>
              <button
