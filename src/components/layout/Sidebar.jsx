...
const Sidebar = () => {
  ...
  return (
    ...
    <aside className={`fixed top-0 right-0 h-full w-112.5 bg-white shadow-2xl z-50 transform transition-transform duration-300 ease-in-out p-8 overflow-y-auto ${recipe ? 'translate-x-0' : 'translate-x-full'}`}>
      {recipe ? (
